...
# install deps
    ...
    apt install ca-certificates cowsay vim rsync curl python3-pip python3-pyqt5 python3-pyqt5.qtsvg python3-dbus udisks2 network-manager fonts-roboto qrencode --yes
