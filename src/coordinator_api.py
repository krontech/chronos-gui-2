...
class ControlAPI(QObject):
	...
	def saveRegions(self, regions: List[Dict[str, Union[int, str, Dict[str, int]]]]) -> List[Dict[str, Union[bool, str]]]:
		"""Save video clips to disk or network.
			...
			As with waterfallMotionMap, if no segment id is specified,
			'all recorded data' is considered to be the segment, and
			start/end is relative to all recorded data."""
		...
		#	"id": str,
		#	"path": str,
		#	"format": {'fps': int, 'bpp': float, 'maxBitrate': int},
		#}]
