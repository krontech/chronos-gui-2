...
class CamObject:
	...
	def setLiveOutputTiming(self, hRes, vRes, hOutRes, vOutRes, maxFps):
		...
		print(self.fpga)
		print(self.display)
		print(self.display.hRes)
		
		# breakpoint()
		self.display.hRes = hRes
		self.display.hOutRes = hOutRes
		self.display.vRes = vRes
		self.display.vOutRes = vOutRes

		self.display.hPeriod = hPeriod - 1
		self.display.hSyncLen = hSync
		self.display.hBackPorch = hBackPorch

		self.display.vPeriod = vPeriod - 1
		self.display.vSyncLen = vSync
		self.display.vBackPorch = vBackPorch
