...
class ControlAPIMock(QObject):
	...
	def waterfallMotionMap(self, segmentId: str, startFrame: int) -> [[int]]:
		"""Get a waterfall-style heatmap of movement in each of the 16 quadrants of the frame.
			...
			"""
		startFrame = startFrame % 5 #Cycle period of data below.
		
		return [
			[0xDE, 0x90, 0x46, 0x31, 0x30, 0x63, 0x00, 0x88, 0xFF, 0x47, 0x4F, 0xCC, 0x53, 0xDE, 0xAB, 0x36],
			[0x50, 0x82, 0x78, 0x20, 0x43, 0xCA, 0x00, 0x88, 0xFF, 0x16, 0x7E, 0x4A, 0xB1, 0x2C, 0xE0, 0xF0],
			[0x3C, 0xA9, 0x7D, 0x47, 0x94, 0xED, 0x00, 0x88, 0xFF, 0x3F, 0xFF, 0xF5, 0xEA, 0xAF, 0x46, 0x8E],
			[0xAC, 0x42, 0x81, 0xFE, 0xE6, 0x1F, 0x00, 0x88, 0xFF, 0xBB, 0x89, 0xD1, 0x4B, 0x0B, 0xD9, 0x9A],
			[0xAC, 0x42, 0x81, 0xFE, 0xE6, 0x1F, 0x00, 0x88, 0xFF, 0xBB, 0x89, 0xD1, 0x4B, 0x0B, 0xD9, 0x9A],
			[0xDE, 0x90, 0x46, 0x31, 0x30, 0x63, 0x00, 0x88, 0xFF, 0x47, 0x4F, 0xCC, 0x53, 0xDE, 0xAB, 0x36],
			[0x50, 0x82, 0x78, 0x20, 0x43, 0xCA, 0x00, 0x88, 0xFF, 0x16, 0x7E, 0x4A, 0xB1, 0x2C, 0xE0, 0xF0],
			[0x3C, 0xA9, 0x7D, 0x47, 0x94, 0xED, 0x00, 0x88, 0xFF, 0x3F, 0xFF, 0xF5, 0xEA, 0xAF, 0x46, 0x8E],
		...
		][startFrame:startFrame+random.choice([1,1,1,2,2,3])]