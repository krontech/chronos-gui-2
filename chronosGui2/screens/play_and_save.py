...
if api.apiValues.get('cameraModel')[0:2] == 'TX':
	from chronosGui2.generated.txpro import Ui_PlayAndSave
else:
...
class PlayAndSave(QtWidgets.QDialog, Ui_PlayAndSave):
	...
	def onHide(self):
		...
		api.unobserve('state', self.onStateChangeWhenScreenActive)
	...
	def addMarkedRegion(self):
		...
		log.info(f'Marked region {self.markedRegions}')
